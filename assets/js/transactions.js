...
const Transactions = {
    ...
    bindEvents: () => {
        ...
        document.getElementById('tx-type').addEventListener('change', (e) => {
            ...
            Transactions.updateCategoryDropdown(type);
            
            // Tampilkan pilihan To-Account hanya jika tipenya Transfer
    ...
    populateDropdowns: () => {
        ...
        const formToAcc = document.getElementById('tx-to-account');
        if (formToAcc) formToAcc.innerHTML = accHtml;
